...
public class StringLengthValidator extends ValidatorBase
{
   ...
   /**
    * Basic constructor with Default message this way: "Max length is " + StringLength +" character(s)
    * "
    *
   ...
   /**
    * The displayed message shown will be concatenated by the message with StringLength this way
   ...
   /**
    * The displayed message will be personalized, but still need to indicate the StringLength to
    * validate.
    *
    * @param StringLength Length of the string in the input field to validate.
    * @param message      Message to show.
