...
/**
 * JFXCheckBox is the material design implementation of a checkbox. it shows ripple effect and a
...
public class JFXCheckBox extends CheckBox
{
   ...
   /**
    * Indicates whether or not this {@link JFXCheckBox} will show focus when it receives keyboard
    * focus.
    * 
   ...
   /**
    * Setting this to true will disable this {@link JFXCheckBox} from showing focus when it receives
    * keyboard focus.
    * 
   ...
   {
      private static final CssMetaData<JFXCheckBox, Paint> CHECKED_COLOR = new CssMetaData<JFXCheckBox, Paint>("-jfx-checked-color",
      ...
      private static final CssMetaData<JFXCheckBox, Paint> UNCHECKED_COLOR = new CssMetaData<JFXCheckBox, Paint>("-jfx-unchecked-color",
                                                                                                                 PaintConverter.getInstance(),
                                                                                                                 Color.valueOf("#5A5A5A"))
      {
         @Override
      ...
      private static final CssMetaData<JFXCheckBox, Boolean> DISABLE_VISUAL_FOCUS = new CssMetaData<JFXCheckBox, Boolean>("-jfx-disable-visual-focus",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(CheckBox.getClassCssMetaData());
