...
/**
 * JFX Toggle Node , allows any node set as its graphic to be toggled not that JFXToggleNode
 * background color MUST match the unselected color property, else the toggle animation will not be
 * consistent. Notice that the default value for unselected color is set to transparent color.
 *
...
public class JFXToggleNode extends ToggleButton
{
    ...
    */
   private StyleableObjectProperty<Color> unSelectedColor = new SimpleStyleableObjectProperty<>(StyleableProperties.UNSELECTED_COLOR,
                                                                                                JFXToggleNode.this,
                                                                                                "unSelectedCOlor",
                                                                                                Color.TRANSPARENT);
   ...
   /**
    * Indicates whether or not this {@link JFXToggleNode} will show focus when it receives keyboard
    * focus.
    *
   ...
   /**
    * Setting this to true will disable this {@link JFXToggleNode} from showing focus when it receives
    * keyboard focus.
    *
   ...
   {
      private static final CssMetaData<JFXToggleNode, Color> SELECTED_COLOR = new CssMetaData<JFXToggleNode, Color>("-jfx-toggle-color",
      ...
      private static final CssMetaData<JFXToggleNode, Color> UNSELECTED_COLOR = new CssMetaData<JFXToggleNode, Color>("-jfx-untoggle-color",
                                                                                                                      ColorConverter.getInstance(),
                                                                                                                      Color.TRANSPARENT)
      {
         @Override
      ...
      private static final CssMetaData<JFXToggleNode, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXToggleNode, Boolean>("-jfx-disable-animation",
      ...
      private static final CssMetaData<JFXToggleNode, Boolean> DISABLE_VISUAL_FOCUS = new CssMetaData<JFXToggleNode, Boolean>("-jfx-disable-visual-focus",
                                                                                                                              BooleanConverter.getInstance(),
                                                                                                                              false)
      {
         @Override
