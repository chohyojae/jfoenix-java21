 ...
 * control, thus it support modality options and doesn't require a parent to be specified unlike
 * {@link JFXDialog}
 *
...
public class JFXAlert<R> extends Dialog<R>
{
   ...
   /**
    * play the hide animation for the dialog, as the java hide method is set to final so it can not be
    * overridden
    */
   ...
   /**
    * specify the animation when showing / hiding the dialog by default it's set to
    * {@link JFXAlertAnimation#CENTER_ANIMATION}
    */
