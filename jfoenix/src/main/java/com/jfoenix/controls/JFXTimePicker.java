...
public class JFXTimePicker extends ComboBoxBase<LocalTime> implements IFXValidatableControl
{
   ...
   /**
    * the parent node used when showing the data picker content as an overlay, intead of a popup
    */
   ...
   /**
    * show the popup as an overlay using JFXDialog NOTE: to show it properly the scene root must be
    * StackPane, or the user must set the dialog parent manually using the property
    * {{@link #dialogParentProperty()}
    */
   ...
   {
      private static final CssMetaData<JFXTimePicker, Paint> DEFAULT_COLOR = new CssMetaData<JFXTimePicker, Paint>("-jfx-default-color",
      ...
      private static final CssMetaData<JFXTimePicker, Boolean> OVERLAY = new CssMetaData<JFXTimePicker, Boolean>("-jfx-overlay",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(ComboBoxBase.getClassCssMetaData());
