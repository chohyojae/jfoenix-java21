...
public class JFXAutoCompletePopup<T> extends PopupControl
{
   ...
   public final void setSuggestionsCellFactory(final javafx.util.Callback<ListView<T>, ListCell<T>> suggestionsCellFactory)
   {
   ...
   {
      private static final CssMetaData<JFXAutoCompletePopup.CSSBridge, Number> FIXED_CELL_SIZE = new CssMetaData<JFXAutoCompletePopup.CSSBridge, Number>("-fx-fixed-cell-size",
      ...
      private static final CssMetaData<JFXAutoCompletePopup.CSSBridge, Number> CELL_LIMIT = new CssMetaData<JFXAutoCompletePopup.CSSBridge, Number>("-jfx-cell-limit",
                                                                                                                                                    SizeConverter.getInstance(),
                                                                                                                                                    10)
      {
         @Override
