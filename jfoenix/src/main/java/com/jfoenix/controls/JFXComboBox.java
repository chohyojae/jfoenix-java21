...
public class JFXComboBox<T> extends ComboBox<T> implements IFXLabelFloatControl
{
    ...
    **************************************************************************/
   /**
    * Converts the user-typed input (when the ComboBox is {@link #editableProperty() editable}) to an
    * object of type T, such that the input may be retrieved via the {@link #valueProperty() value}
    * property.
    */
   ...
   private ObjectProperty<NodeConverter<T>> nodeConverter = new SimpleObjectProperty<>(this, "nodeConverter", JFXComboBox.<T> defaultNodeConverter());
   ...
   {
      private static final CssMetaData<JFXComboBox<?>, Paint> UNFOCUS_COLOR = new CssMetaData<JFXComboBox<?>, Paint>("-jfx-unfocus-color",
      ...
      private static final CssMetaData<JFXComboBox<?>, Paint> FOCUS_COLOR = new CssMetaData<JFXComboBox<?>, Paint>("-jfx-focus-color",
                                                                                                                   PaintConverter.getInstance(),
      ...
      private static final CssMetaData<JFXComboBox<?>, Boolean> LABEL_FLOAT = new CssMetaData<JFXComboBox<?>, Boolean>("-jfx-label-float",
      ...
      private static final CssMetaData<JFXComboBox, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXComboBox, Boolean>("-jfx-disable-animation",
                                                                                                                       BooleanConverter.getInstance(),
                                                                                                                       false)
      {
         @Override
