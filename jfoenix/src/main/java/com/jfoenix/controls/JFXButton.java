...
/**
 * JFXButton is the material design implementation of a button. it contains ripple effect , the
 * effect color is set according to text fill of the button 1st or the text fill of graphic node (if
 * it was set to Label) 2nd.
 *
...
public class JFXButton extends Button
{
   ...
   /**
    * according to material design the button has two types: - flat : only shows the ripple effect upon
    * clicking the button - raised : shows the ripple effect and change in depth upon clicking the
    * button
    */
   private StyleableObjectProperty<ButtonType> buttonType = new SimpleStyleableObjectProperty<>(StyleableProperties.BUTTON_TYPE,
                                                                                                JFXButton.this,
                                                                                                "buttonType",
                                                                                                ButtonType.FLAT);
   ...
   /**
    * Setting this to true will disable this {@link JFXButton} from showing focus when it receives
    * keyboard focus.
    * 
   ...
   {
      private static final CssMetaData<JFXButton, ButtonType> BUTTON_TYPE = new CssMetaData<JFXButton, ButtonType>("-jfx-button-type",
                                                                                                                   ButtonTypeConverter.getInstance(),
                                                                                                                   ButtonType.FLAT)
      {
         @Override
      ...
      private static final CssMetaData<JFXButton, Boolean> DISABLE_VISUAL_FOCUS = new CssMetaData<JFXButton, Boolean>("-jfx-disable-visual-focus",
