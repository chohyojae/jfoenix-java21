 ...
 * field. Sub-classes can provide formatters for display and a commitHelper to control when editing
 * is committed.
 * <p>
 *
...
public class GenericEditableTableCell<S, T> extends TableCell<S, T>
{
   ...
   /**
    * constructor that creates the default {@link TextFieldEditorBuilder TextField} editor node to edit
    * the cell
    */
