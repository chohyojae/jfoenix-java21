 ...
 * <p>
 * UPDATE : DrawersStack extends Region instead of StackPane to encapsulate the getChildren() method
...
public class JFXDrawersStack extends Region
{
   ...
   /**
    * @return the content of the drawer stack (Note: the parent of the content node is that latest
    *         active drawer if existed)
    */
    ...
    * <p>
    * NOTE: this method is also called inside {@link JFXDrawersStack#toggle(JFXDrawer)} to add the
    * drawer if not added
    *
    * @param drawer
    */
