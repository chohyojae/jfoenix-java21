 ...
 * <ol>
 * <li>Have a {@link Pane} (snackbarContainer) to show the snackbar on top of. Register it in
 * {@link #JFXSnackbar(Pane) the JFXSnackbar constructor} or using the
 * {@link #registerSnackbarContainer(Pane)} method.</li>
 * <li>Have or create a {@link JFXSnackbar}.
 * <ul>
 * <li>Having one snackbar where you pass all your {@link JFXSnackbar.SnackbarEvent SnackbarEvents}
 * will ensure that the {@link JFXSnackbar#enqueue(SnackbarEvent) enqueue method} works as
 * intended.</li>
 * </ul>
 * </li>
 * <li>Have something to show in the snackbar. A {@link JFXSnackbarLayout} is nice and pretty, but
 * any arbitrary {@link Node} will do.</li>
 ...
 *
 * @see <a href="https://material.io/design/components/snackbars.html#"> The Material Design
 *      Snackbar</a>
 */
public class JFXSnackbar extends Group
{
   ...
   /**
    * This constructor assumes that you will eventually call the
    * {@link #registerSnackbarContainer(Pane)} method before calling the
    * {@link #enqueue(SnackbarEvent)} method. Otherwise, how will the snackbar know where to show
    * itself?
    * <p>
    * <p>
    * "Snackbars provide brief messages about app processes at the bottom of the screen"
    ...
    * <p>
    *
    * @param snackbarContainer where the snackbar will appear. Using a single snackbar instead of many,
    *                          will ensure that the {@link #enqueue(SnackbarEvent)} method works
    *                          correctly.
    */
   ...
   private Timeline getTimeline(Duration timeout)
   {
      ...
      animation = new Timeline(new KeyFrame(Duration.ZERO,
                               ...
                               new KeyFrame(Duration.millis(10), e -> this.toFront(), new KeyValue(this.visibleProperty(), true, Interpolator.EASE_BOTH)),
   ...
   public void close()
   {
      ...
      if (this.isVisible())
      {
         Timeline closeAnimation = new Timeline(new KeyFrame(Duration.ZERO,
                                                             e -> this.toFront(),
                                                             new KeyValue(this.opacityProperty(), 1, easeInterpolator),
                                                             new KeyValue(this.translateYProperty(), 0, easeInterpolator)),
                                                new KeyFrame(Duration.millis(290), new KeyValue(this.visibleProperty(), true, Interpolator.EASE_BOTH)),
                                                new KeyFrame(Duration.millis(300),
                                                             e -> this.toBack(),
                                                             new KeyValue(this.visibleProperty(), false, Interpolator.EASE_BOTH),
                                                             new KeyValue(this.translateYProperty(), this.getLayoutBounds().getHeight(), easeInterpolator),
   ...
   /**
    * Shows {@link SnackbarEvent SnackbarEvents} one by one. The next event will be shown after the
    * current event's duration.
    *
    ...
    * <p>
    * The <em>what</em> can be any arbitrary {@link Node}; the {@link JFXSnackbarLayout} is a great
    * choice.
    * <p>
    * The <em>how long</em> is specified in the form of a {@link javafx.util.Duration
    * javafx.util.Duration}, not to be confused with the {@link java.time.Duration}.
    */
   public static class SnackbarEvent extends Event
   {
      ...
      /**
       * Creates a {@link SnackbarEvent} with the {@link #DEFAULT_DURATION default duration} and no
       * pseudoClass.
       *
       * @param content what you want shown in the snackbar; a {@link JFXSnackbarLayout} is a great
       *                choice.
       */
      ...
      /**
       * Creates a {@link SnackbarEvent} with the {@link #DEFAULT_DURATION default duration}; you specify
       * the contents and pseudoClass.
       *
       * @param content     what you want shown in the snackbar; a {@link JFXSnackbarLayout} is a great
       *                    choice.
       * @param pseudoClass
      ...
      /**
       * Creates a SnackbarEvent with no pseudoClass; you specify the contents and duration. pseudoClass.
       *
       * @param content what you want shown in the snackbar; a {@link JFXSnackbarLayout} is a great
       *                choice.
