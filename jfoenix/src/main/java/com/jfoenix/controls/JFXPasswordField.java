...
public class JFXPasswordField extends PasswordField implements IFXLabelFloatControl
{
   ...
   {
      private static final CssMetaData<JFXPasswordField, Paint> UNFOCUS_COLOR = new CssMetaData<JFXPasswordField, Paint>("-jfx-unfocus-color",
      ...
      private static final CssMetaData<JFXPasswordField, Paint> FOCUS_COLOR = new CssMetaData<JFXPasswordField, Paint>("-jfx-focus-color",
                                                                                                                       PaintConverter.getInstance(),
      ...
      private static final CssMetaData<JFXPasswordField, Boolean> LABEL_FLOAT = new CssMetaData<JFXPasswordField, Boolean>("-jfx-label-float",
      ...
      private static final CssMetaData<JFXPasswordField, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXPasswordField, Boolean>("-fx-disable-animation",
                                                                                                                                 BooleanConverter.getInstance(),
                                                                                                                                 false)
      {
         @Override
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(PasswordField.getClassCssMetaData());
