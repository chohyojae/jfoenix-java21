...
public class JFXDialogEvent extends Event
{
   ...
   /**
    * This event occurs when a JFXDialog is closed, no longer visible to the user ( after the exit
    * animation ends )
    */
   public static final EventType<JFXDialogEvent> CLOSED = new EventType<>(Event.ANY, "JFX_DIALOG_CLOSED");

   /**
    * This event occurs when a JFXDialog is opened, visible to the user ( after the entrance animation
    * ends )
    */
