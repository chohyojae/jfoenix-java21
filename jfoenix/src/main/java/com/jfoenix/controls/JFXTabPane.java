...
public class JFXTabPane extends TabPane
{
   ...
   {
      private static final CssMetaData<JFXTabPane, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXTabPane, Boolean>("-jfx-disable-animation",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(TabPane.getClassCssMetaData());
