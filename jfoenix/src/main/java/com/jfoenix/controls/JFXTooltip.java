...
public class JFXTooltip extends Tooltip
{
   ...
   private static TooltipBehavior BEHAVIOR = new TooltipBehavior(Duration.millis(650), Duration.millis(1500), Duration.millis(200));
   ...
   /**
    * Associates the given {@link JFXTooltip} tooltip to the given node. The tooltip will be shown
    * according to the given {@link Pos} pos
    *
    * @param node
    * @param tooltip
    */
   ...
   private JFXAnimationTimer animation = new JFXAnimationTimer(JFXKeyFrame.builder()
                                                                          ...
                                                                          .build(),
                                                               JFXKeyFrame.builder()
                                                                          .setDuration(Duration.millis(75))
                                                                          .setAnimateCondition(() -> hiding)
                                                                          .setKeyValues(JFXKeyValue.builder()
                                                                                                   .setTargetSupplier(() -> root.opacityProperty())
                                                                                                   .setEndValue(0)
   ...
   /**
    * sets the gap between tooltip and the associated node. the default value is 8
    *
    * @param margin
    */
   ...
   /**
    * {@inheritDoc} this method ignores anchorX, anchorY. It shows the tooltip according to tooltip
    * {@link JFXTooltip#pos} field
    * <p>
    * NOTE: if you want to manually show the tooltip on forced local anchors you can use
    * {@link JFXTooltip#showOnAnchors(Node, double, double)} method.
    */
   @Override
