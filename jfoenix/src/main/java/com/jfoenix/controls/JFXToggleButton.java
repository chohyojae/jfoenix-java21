...
/**
 * JFXToggleButton is the material design implementation of a toggle button. important CSS
 * Selectors:
 * <p>
 * .jfx-toggle-button{ -fx-toggle-color: color-value; -fx-untoggle-color: color-value;
 * -fx-toggle-line-color: color-value; -fx-untoggle-line-color: color-value; }
 * <p>
 * To change the rippler color when toggled:
 * <p>
 * .jfx-toggle-button .jfx-rippler{ -fx-rippler-fill: color-value; }
 * <p>
 * .jfx-toggle-button:selected .jfx-rippler{ -fx-rippler-fill: color-value; }
 *
...
public class JFXToggleButton extends ToggleButton
{
    ...
    */
   private StyleableObjectProperty<Paint> toggleLineColor = new SimpleStyleableObjectProperty<>(StyleableProperties.TOGGLE_LINE_COLOR,
                                                                                                JFXToggleButton.this,
                                                                                                "toggleLineColor",
    ...
    */
   private StyleableObjectProperty<Paint> untoggleLineColor = new SimpleStyleableObjectProperty<>(StyleableProperties.UNTOGGLE_LINE_COLOR,
                                                                                                  JFXToggleButton.this,
                                                                                                  "unToggleLineColor",
    ...
    */
   private final StyleableDoubleProperty size = new SimpleStyleableDoubleProperty(StyleableProperties.SIZE, JFXToggleButton.this, "size", 10.0);
   ...
   {
      private static final CssMetaData<JFXToggleButton, Paint> TOGGLE_COLOR = new CssMetaData<JFXToggleButton, Paint>("-jfx-toggle-color",
      ...
      private static final CssMetaData<JFXToggleButton, Paint> UNTOGGLE_COLOR = new CssMetaData<JFXToggleButton, Paint>("-jfx-untoggle-color",
                                                                                                                        PaintConverter.getInstance(),
                                                                                                                        Color.valueOf("#FAFAFA"))
      {
         @Override
      ...
      private static final CssMetaData<JFXToggleButton, Paint> TOGGLE_LINE_COLOR = new CssMetaData<JFXToggleButton, Paint>("-jfx-toggle-line-color",
                                                                                                                           PaintConverter.getInstance(),
                                                                                                                           Color.valueOf("#77C2BB"))
      {
         @Override
      ...
      private static final CssMetaData<JFXToggleButton, Paint> UNTOGGLE_LINE_COLOR = new CssMetaData<JFXToggleButton, Paint>("-jfx-untoggle-line-color",
                                                                                                                             PaintConverter.getInstance(),
                                                                                                                             Color.valueOf("#999999"))
      {
         @Override
      ...
      private static final CssMetaData<JFXToggleButton, Number> SIZE = new CssMetaData<JFXToggleButton, Number>("-jfx-size",
      ...
      private static final CssMetaData<JFXToggleButton, Boolean> DISABLE_VISUAL_FOCUS = new CssMetaData<JFXToggleButton, Boolean>("-jfx-disable-visual-focus",
      ...
      private static final CssMetaData<JFXToggleButton, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXToggleButton, Boolean>("-jfx-disable-animation",
                                                                                                                               BooleanConverter.getInstance(),
                                                                                                                               false)
      {
         @Override
