...
public class JFXDatePicker extends DatePicker implements IFXValidatableControl
{
   ...
   {
      private static final CssMetaData<JFXDatePicker, Paint> DEFAULT_COLOR = new CssMetaData<JFXDatePicker, Paint>("-jfx-default-color",
      ...
      private static final CssMetaData<JFXDatePicker, Boolean> OVERLAY = new CssMetaData<JFXDatePicker, Boolean>("-jfx-overlay",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(DatePicker.getClassCssMetaData());
