...
public class JFXSlider extends Slider
{
   ...
   /**
    * String binding factory for the slider value. Sets a custom string for the value text (by default,
    * it shows the value rounded to the nearest whole number).
    * <p>
    * <p>
    * For example, to have the value displayed as a percentage (assuming the slider has a range of (0,
    * 100)):
    * 
    * <pre>
    * <code>
   ...
   /**
    * indicates the position of the slider indicator, can be either LEFT or RIGHT
    */
   private StyleableObjectProperty<IndicatorPosition> indicatorPosition = new SimpleStyleableObjectProperty<>(StyleableProperties.INDICATOR_POSITION,
                                                                                                              JFXSlider.this,
                                                                                                              "indicatorPosition",
   ...
   {
      private static final CssMetaData<JFXSlider, IndicatorPosition> INDICATOR_POSITION = new CssMetaData<JFXSlider, IndicatorPosition>("-jfx-indicator-position",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(Slider.getClassCssMetaData());
