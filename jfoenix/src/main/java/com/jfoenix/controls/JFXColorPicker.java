...
public class JFXColorPicker extends ColorPicker
{
   ...
   private static class StyleableProperties
   {
      ...
      private static final CssMetaData<JFXColorPicker, Boolean> DISABLE_ANIMATION = new CssMetaData<JFXColorPicker, Boolean>("-jfx-disable-animation",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(ColorPicker.getClassCssMetaData());
