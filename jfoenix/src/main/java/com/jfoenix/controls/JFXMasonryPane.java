 ...
 * <p>
 * <h3>Bin Packing Layout(First Fit)</h3> it works similar to masonry layoutMode, however it tries
 * to fill the empty gaps caused in masonry layoutMode. <b>Note:</b> children that doesn't fit in
...
public class JFXMasonryPane extends Pane
{
   ...
   /**
    * this method will clear the layout matrix forcing the bin packing algorithm to recompute the
    * children boxes on the next layout pass
    */
   ...
   /**
    * @return -1 if no limit on grid columns, else returns the maximum number of columns to be used in
    *         the grid
    */
   ...
   /**
    * @return -1 if no limit on grid rows, else returns the maximum number of rows to be used in the
    *         grid
    */
   ...
   public static abstract class LayoutMode
   {
       ...
       * @return
       */
      protected BoundingBox getFreeArea(int[][] matrix,
                                        int x,
                                        int y,
                                        Region block,
                                        double cellWidth,
   ...
   {
      @Override
      public List<BoundingBox> fillGrid(int[][] matrix,
                                        List<Region> children,
                                        double cellWidth,
                                        double cellHeight,
                                        int limitRow,
