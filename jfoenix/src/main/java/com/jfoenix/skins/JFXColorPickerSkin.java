...
public class JFXColorPickerSkin extends JFXGenericPickerSkin<Color>
{
   ...
   {
      private static final CssMetaData<ColorPicker, Boolean> COLOR_LABEL_VISIBLE = new CssMetaData<ColorPicker, Boolean>("-fx-color-label-visible",
      ...
      static
      {
         final List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(ComboBoxPopupControl.getClassCssMetaData());
