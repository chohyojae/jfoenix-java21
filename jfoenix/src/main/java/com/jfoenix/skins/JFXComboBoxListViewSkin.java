...
public class JFXComboBoxListViewSkin<T> extends ComboBoxListViewSkin<T>
{
   ...
   public JFXComboBoxListViewSkin(final JFXComboBox<T> comboBox)
   {
      ...
      linesWrapper = new PromptLinesWrapper<>(comboBox, promptTextFill, comboBox.valueProperty(), comboBox.promptTextProperty(), () -> promptText);
   ...
   {
      private static final CssMetaData<JFXComboBox, Paint> PROMPT_TEXT_FILL = new CssMetaData<JFXComboBox, Paint>("-fx-prompt-text-fill",
      ...
      static
      {
         List<CssMetaData<? extends Styleable, ?>> styleables = new ArrayList<>(ComboBoxListViewSkin.getClassCssMetaData());
