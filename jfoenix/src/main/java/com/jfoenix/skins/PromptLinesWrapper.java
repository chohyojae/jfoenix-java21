...
public class PromptLinesWrapper<T extends Control & IFXLabelFloatControl>
{
   ...
   public PromptLinesWrapper(T control,
   ...
   public void init(Runnable createPromptNodeRunnable, Node... cachedNodes)
   {
      ...
      focusTimer = new JFXAnimationTimer(new JFXKeyFrame(Duration.millis(1),
                                                         JFXKeyValue.builder()
      ...
      unfocusTimer = new JFXAnimationTimer(new JFXKeyFrame(Duration.millis(160),
                                                           JFXKeyValue.builder()
                                                                      .setTargetSupplier(promptTargetSupplier)
                                                                      .setEndValue(0)
                                                                      .setInterpolator(Interpolator.EASE_BOTH)
   ...
   /**
    * this method is called when the text property is changed when the field is not focused (changed in
    * code)
    *
   ...
   private boolean usePromptText()
   {
      ...
      return isLabelFloat
             || (promptTxt != null && (txt == null || txt.toString().isEmpty()) && !promptTxt.isEmpty() && !promptTextFill.get().equals(Color.TRANSPARENT));
   }
   ...
   public void updateDisabled()
   {
      ...
      line.setBorder(!disabled ? Border.EMPTY
                               : new Border(new BorderStroke(control.getUnFocusColor(), BorderStrokeStyle.DASHED, CornerRadii.EMPTY, new BorderWidths(1))));
