...
public class JFXRadioButtonSkin extends RadioButtonSkin
{
   ...
   public JFXRadioButtonSkin(JFXRadioButton control)
   {
      ...
      rippler = new JFXRippler(container, RipplerMask.CIRCLE)
      {
         ...
         protected void initControlListeners()
         {
            ...
            control.addEventHandler(MouseEvent.MOUSE_PRESSED, (event) -> createRipple(event.getX() + padding, event.getY() + padding));
      ...
      timer = new JFXAnimationTimer(new JFXKeyFrame(Duration.millis(200),
                                                    JFXKeyValue.builder()
                                                    ...
                                                    JFXKeyValue.builder()
                                                               ...
                                                               .setEndValueSupplier(() -> getSkinnable().isSelected() ? ((JFXRadioButton) getSkinnable()).getSelectedColor()
   ...
   {
      return super.computeMinWidth(height, topInset, rightInset, bottomInset, leftInset) + snapSizeX(radio.minWidth(-1)) + padding / 3;
   }

   @Override
   protected double computePrefWidth(double height, double topInset, double rightInset, double bottomInset, double leftInset)
   {
      return super.computePrefWidth(height, topInset, rightInset, bottomInset, leftInset) + snapSizeX(radio.prefWidth(-1)) + padding / 3;
   }
