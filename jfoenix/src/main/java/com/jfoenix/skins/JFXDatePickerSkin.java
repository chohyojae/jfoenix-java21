...
public class JFXDatePickerSkin extends JFXGenericPickerSkin<LocalDate>
{
   ...
   /**
    * TODO: 1. Handle different Chronology
    */
   ...
   {
      ((Region) arrowButton.getChildren().get(0)).setBackground(new Background(new BackgroundFill(datePicker.getDefaultColor(), null, null)));
      ((JFXTextField) getEditor()).setFocusColor(jfxDatePicker.getDefaultColor());
   }
