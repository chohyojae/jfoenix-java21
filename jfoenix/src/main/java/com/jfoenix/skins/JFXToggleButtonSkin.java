...
public class JFXToggleButtonSkin extends ToggleButtonSkin
{
   ...
   public JFXToggleButtonSkin(JFXToggleButton toggleButton)
   {
      ...
      timer = new JFXAnimationTimer(new JFXKeyFrame(Duration.millis(100),
                                                    JFXKeyValue.builder()
                                                    ...
                                                    JFXKeyValue.builder()
                                                               ...
                                                               .setEndValueSupplier(() -> getSkinnable().isSelected() ? ((JFXToggleButton) getSkinnable()).getToggleLineColor()
                                                    ...
                                                    JFXKeyValue.builder()
                                                               ...
                                                               .setEndValueSupplier(() -> getSkinnable().isSelected() ? ((JFXToggleButton) getSkinnable()).getToggleColor()
