...
/**
 * it will create a shadow effect for a given node and a specified depth level. depth levels are
 * {0,1,2,3,4,5}
 *
...
public class JFXDepthManager
{
   ...
   private static DropShadow[] depth = new DropShadow[] {new DropShadow(BlurType.GAUSSIAN, Color.rgb(0, 0, 0, 0), 0, 0, 0, 0),
   ...
   /**
    * this method is used to add shadow effect to the node, however the shadow is not real ( gets
    * affected with node transformations)
    * <p>
    ...
    * to the shadow effect (which makes it looks as a real shadow)
    */
