...
/**
 * This {@code Transition} creates an animation, that changes the filling of a pane over a
 * {@code duration}. This is done by updating the {@code background} property of the {@code pane} at
 * regular intervals.
 * <p>
 ...
 * <p>
 * It's similar to JavaFX FillTransition, however it can be applied on Region instead of shape
 *
...
public final class JFXFillTransition extends Transition
{
    ...
    * <p>
    * Note: While the unit of {@code duration} is a millisecond, the granularity depends on the
    * underlying operating system and will in general be larger. For example animations on desktop
    * systems usually run with a maximum of 60fps which gives a granularity of ~17 ms.
    * <p>
    ...
    */
   public JFXFillTransition(Duration duration, Region region, Color fromValue, Color toValue)
   {
