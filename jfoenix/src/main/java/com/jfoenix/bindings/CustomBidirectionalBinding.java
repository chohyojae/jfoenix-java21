...
public class CustomBidirectionalBinding<A, B> implements IBiBinder
{
   ...
   {
      this(a, value -> a.setValue(value), b, value -> b.setValue(value), converter);
   }

   public CustomBidirectionalBinding(ReadOnlyProperty<A> a,
                                     Consumer<A> propertyRef1Setter,
                                     ReadOnlyProperty<B> b,
                                     Consumer<B> propertyRef2Setter,
   ...
   private <a, b> void addFlaggedChangeListener(ReadOnlyProperty<a> a,
                                                Consumer<a> aConsumer,
                                                ReadOnlyProperty<b> b,
