...
public class SVGGlyph extends Pane
{
   ...
   /**
    * Constructs SVGGlyph node for a specified svg content and color <b>Note:</b> name and glyphId is
    * not needed when creating a single SVG image, they have been used in {@link SVGGlyphLoader} to
    * load icomoon svg font.
    *
   ...
   {
      private static final CssMetaData<SVGGlyph, Number> SIZE = new CssMetaData<SVGGlyph, Number>("-jfx-size",
