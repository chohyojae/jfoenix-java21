...
public class TreeTableViewController
{
   ...
   private final String[] names = {"Morley",
                                   "Scott",
                                   "Kruger",
                                   "Lain",
                                   "Kennedy",
   ...
   private void setupEditableTableView()
   {
      ...
      {
         t.getTreeTableView().getTreeItem(t.getTreeTablePosition().getRow()).getValue().lastName.set(t.getNewValue());
      });
      ...
      {
         t.getTreeTableView().getTreeItem(t.getTreeTablePosition().getRow()).getValue().age.set(t.getNewValue());
      });
